...
export default function Prompts() {
  ...
  const prompts = [
    ...
    },
    {
      ...
      descricao:
        "Crie uma abordagem profissional para prospectar clientes.",
      prompt:
    ...
    },
    {
      ...
      descricao:
        "Crie legendas estratégicas para suas publicações.",
      prompt:
    ...
    },
    {
      ...
      descricao:
        "Entenda como melhorar seu posicionamento.",
      prompt:
    ...
    },
    {
      ...
      descricao:
        "Transforme uma ideia em um plano de ação.",
      prompt:
  ...
  const promptsFiltrados = prompts.filter((item) => {
    ...
    const textoBusca =
      `${item.titulo} ${item.descricao} ${item.categoria}`.toLowerCase();

    const correspondeBusca = textoBusca.includes(
      busca.toLowerCase()
    );
    ...
    <main style={styles.page}>
      ...
      <section style={styles.hero}>
        ...
        <p style={styles.description}>
          Encontre comandos prontos para criar conteúdo,
          vender, divulgar seu negócio e encontrar novas
          oportunidades.
        </p>
        ...
        <div style={styles.sectionHeader}>
          <div>
            ...
            <p style={styles.sectionDescription}>
              Escolha um prompt e adapte os campos entre
              colchetes.
            </p>
          </div>
        ...
        {promptsFiltrados.length === 0 && (
          <div style={styles.empty}>
            ...
            <p style={styles.emptyText}>
              Tente pesquisar outro termo ou selecione
              a categoria "Todos".
            </p>
          </div>
        )}
      ...
      <section style={styles.tip}>
        ...
        <div>
          ...
          <p style={styles.tipText}>
            Quanto mais informações você fornecer para
            a IA, mais específica tende a ser a resposta.
            Substitua os campos entre [COLCHETES] antes
            de enviar o prompt.
          </p>
        </div>
      </section>
      ...
      <footer style={styles.footer}>
        ...
        <p>
          Inteligência artificial para criar novas
          oportunidades.
        </p>
