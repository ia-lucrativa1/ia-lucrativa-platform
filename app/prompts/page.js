...
<div style={styles.brand}>IA LUCRATIVA</div>
  ...
  <section style={styles.hero}>
    ...
    <p style={styles.description}>
      Encontre comandos prontos para criar conteúdo, vender,
      divulgar seu negócio e encontrar novas oportunidades.
    </p>
  ...
  <section style={styles.container}>
    ...
    <div style={styles.grid}>
      {promptsFiltrados.map((item) => (
        <article key={item.id} style={styles.card}>
          ...
          <button
            onClick={() =>
              copiarPrompt(item.prompt, item.id)
            }
    ...
    {promptsFiltrados.length === 0 && (
      <div style={styles.empty}>
        ...
        <p>
          Tente pesquisar outro termo ou selecione a categoria
          "Todos".
        </p>
      </div>
    )}
  ...
  <section style={styles.tip}>
    ...
    <div>
      ...
      <p style={styles.tipText}>
        Quanto mais informações você fornecer para a IA, mais
        específica tende a ser a resposta. Substitua os campos
        entre [COLCHETES] antes de enviar o prompt.
      </p>
    </div>
  </section>
  ...
  <footer style={styles.footer}>
    ...
    <p>
      Inteligência artificial para criar novas oportunidades.
    </p>
